...
type tokenTypeChecker func(kind generic.T) bool

// parserConfig holds configuration for customizing the parser
type parserConfig struct {
	ignoredTokenTypes map[generic.T]bool // the token types ignored by the parser
	...
	errorNodeType         generic.U // The node type for error nodes.
	errorMessagePredicate string    // The error message predicate.

	commentNodeType           generic.U // The node type for comment nodes.
	...
	keywordTokenType generic.T // The keyword token type.
	errorTokenType   generic.T // The error token type.
	eofTokenType     generic.T // The EOF token type.
}
...
func (p *sourceParser) createNode(kind generic.U) AstNode {
...
func (p *sourceParser) startNode(kind generic.U) AstNode {
...
func (p *sourceParser) isToken(types ...generic.T) bool {
...
func (p *sourceParser) isNextToken(types ...generic.T) bool {
	token := p.nextToken()
...
func (p *sourceParser) consume(types ...generic.T) (lexeme, bool) {
...
func (p *sourceParser) tryConsume(types ...generic.T) (lexeme, bool) {
...
// tryConsume performs consumption of the next token if it matches any of the given
// types and returns it.
func (p *sourceParser) tryConsumeWithComments(types ...generic.T) (commentedLexeme, bool) {
	if p.isToken(types...) {
...
func (p *sourceParser) consumeUntil(types ...generic.T) lexeme {
	for {
...
func (p *sourceParser) performLeftRecursiveParsing(subTryExprFn tryParserFn, rightNodeBuilder rightNodeConstructor, rightTokenTester lookaheadParserFn, operatorTokens ...generic.T) (AstNode, bool) {
...
func (t *lookaheadTracker) matchToken(types ...generic.T) (lexeme, bool) {
