$module('arrow', function () {
  ...
  this.$class('SomePromise', false, '', function () {
    ...
    this.$typesig = function () {
      var computed = $t.createtypesig(['Then', 2, $g.____testlib.basictypes.Function($g.____testlib.basictypes.Awaitable($g.____testlib.basictypes.Boolean)).$typeref()], ['Catch', 2, $g.____testlib.basictypes.Function($g.____testlib.basictypes.Awaitable($g.____testlib.basictypes.Boolean)).$typeref()], ['new', 1, $g.____testlib.basictypes.Function($g.arrow.SomePromise).$typeref()]);
      this.$typesig = function () {
        return computed;
      };
      return computed;
