  ...
  $static.TEST = function () {
    ...
    var $continue = function ($resolve, $reject) {
      while (true) {
        switch ($current) {
          case 0:
            $g.____testlib.basictypes.List($t.struct).forArray([$t.box(1, $g.____testlib.basictypes.Integer), $t.box(true, $g.____testlib.basictypes.Boolean), $t.box(3, $g.____testlib.basictypes.Integer)]).then(function ($result0) {
              $result = $result0;
              $current = 1;
